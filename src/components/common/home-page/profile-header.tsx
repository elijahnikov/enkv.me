    ...
    <div>
      <div className="block sm:flex">
        <Image
          ...
          className="rounded-2xl border shadow-sm dark:border-neutral-500"
          alt="headshot"
          sizes="100vw"
          width={150}
          height={150}
        ...
        <div className="mt-4 w-full pl-0 sm:mt-0 sm:pl-6">
          ...
          <p className="mt-2 w-[90%] text-sm text-neutral-700 dark:text-neutral-300/80">
          ...
          <div className="mt-2 text-sm text-neutral-700 dark:text-neutral-300/80">
            <p>
